...
class ProductControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'product[adultContent]' => 'Testing',
            'product[author]' => 'Testing',
        ]);
    ...
    public function testShow(): void
    {
        ...
        $fixture->setAdultContent('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'product[adultContent]' => 'Something New',
            'product[author]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getAdultContent());
